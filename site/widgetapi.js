...
*/
    ...
    function va(a) {
        this.next = function(b) {
            oa(a.h);
            a.h.i ? b = ta(a, a.h.i.next, b, a.h.s) : (a.h.s(b),
            b = ua(a));
            return b
        }
        ;
        this["throw"] = function(b) {
            oa(a.h);
            a.h.i ? b = ta(a, a.h.i["throw"], b, a.h.s) : (pa(a.h, b),
            b = ua(a));
            return b
        }
        ;
    ...
    function wa(a, b) {
        var c = new va(new ra(b));
        ma && a.prototype && ma(c, a.prototype);
        return c
    }
    ...
    t("Promise", function(a) {
        ...
        b.prototype.ga = function(g) {
            ...
            "function" == typeof h ? this.ka(h, g) : this.o(g)
        }
        ;
    ...
    t("WeakMap", function(a) {
        ...
        b.prototype.get = function(k) {
            return d(k) && A(k, g) ? k[g][this.h] : void 0
        }
        ;
        b.prototype.has = function(k) {
            return d(k) && A(k, g) && A(k[g], this.h)
        }
        ;
        b.prototype["delete"] = function(k) {
            return d(k) && A(k, g) && A(k[g], this.h) ? delete k[g][this.h] : !1
        }
        ;
        return b
    });
    ...
    t("Map", function(a) {
        ...
        e.prototype["delete"] = function(h) {
            ...
            h.v.previous.next = h.v.next,
            h.v.next.previous = h.v.previous,
            h.v.head = null,
            this.size--,
            !0) : !1
        }
    ...
    var B = this || self;
    function C(a, b) {
        for (var c = a.split("."), d = b || B, e = 0; e < c.length; e++)
            if (d = d[c[e]],
            null == d)
                return null;
        return d
    ...
    var pb = I("Opera")
      , qb = I("Trident") || I("MSIE")
      , rb = I("Edge")
      , sb = I("Gecko") && !(-1 != H.toLowerCase().indexOf("webkit") && !I("Edge")) && !(I("Trident") || I("MSIE")) && !I("Edge")
      , tb = -1 != H.toLowerCase().indexOf("webkit") && !I("Edge");
    function ub() {
        var a = B.document;
    ...
    if (B.document && qb) {
        var Cb = ub();
        Bb = Cb ? Cb : parseInt(zb, 10) || void 0
    } else
        Bb = void 0;
    var Db = Bb;
    var Eb = I("Firefox") || I("FxiOS")
      , Fb = nb() || I("iPod")
      , Gb = I("iPad")
      , Hb = I("Safari") && !((I("Chrome") || I("CriOS")) && !I("Edge") || I("Coast") || I("Opera") || I("Edge") || I("Edg/") || I("OPR") || I("Firefox") || I("FxiOS") || I("Silk") || I("Android")) && !(nb() || I("iPad") || I("iPod"));
    var Ib = {}
      , Jb = null;
    var J = window;
    function Kb(a, b) {
    ...
    r = Kb.prototype;
    r.clone = function() {
        return new Kb(this.width,this.height)
    }
    ;
    ...
    var Ub = {
        Aa: "allow-forms",
        Ba: "allow-modals",
        Ca: "allow-orientation-lock",
        Da: "allow-pointer-lock",
        Ea: "allow-popups",
        Fa: "allow-popups-to-escape-sandbox",
        Ga: "allow-presentation",
        Ha: "allow-same-origin",
        Ia: "allow-scripts",
        Ja: "allow-top-navigation",
        Ka: "allow-top-navigation-by-user-activation"
    }
      , Wb = Sa(function() {
        return Vb()
    });
    ...
    ;
    var ec = null === (bc = ac()) || void 0 === bc ? void 0 : bc.emptyHTML;
    new dc(null !== ec && void 0 !== ec ? ec : "",Zb);
    var fc;
    function gc() {}
    function hc(a, b) {
        $b(b);
    ...
    ;
    var ic = null === (fc = ac()) || void 0 === fc ? void 0 : fc.emptyScript;
    new hc(null !== ic && void 0 !== ic ? ic : "",Zb);
    function jc() {}
    function kc(a, b) {
        $b(b);
        this.h = a
    ...
    ;
    new kc("about:blank",Zb);
    new kc("about:invalid#zTSz",Zb);
    function lc(a) {
    ...
    ;
    var qc = new pc("undefined" == typeof document ? null : document);
    ...
    ;function tc() {
        ...
        function b(n) {
            for (var p = g, q = 0; 64 > q; q += 4)
                p[q / 4] = n[q] << 24 | n[q + 1] << 16 | n[q + 2] << 8 | n[q + 3];
            for (q = 16; 80 > q; q++)
            ...
            for (q = 0; 80 > q; q++) {
                if (40 > q)
                    ...
                    60 > q ? (ea = v & w | y & (v | w),
                    ib = 2400959708) : (ea = v ^ w ^ y,
                    ib = 3395469782);
                ea = ((n << 5 | n >>> 27) & 4294967295) + ea + N + ib + p[q] & 4294967295;
                N = y;
                y = w;
        ...
        function c(n, p) {
            if ("string" === typeof n) {
                ...
                for (var q = [], v = 0, w = n.length; v < w; ++v)
                    q.push(n.charCodeAt(v));
                n = q
            }
            p || (p = n.length);
            q = 0;
        ...
        return {
            ...
            la: function() {
                for (var n = d(), p = "", q = 0; q < n.length; q++)
                    p += "0123456789ABCDEF".charAt(Math.floor(n[q] / 16)) + "0123456789ABCDEF".charAt(n[q] % 16);
                return p
            }
        }
    }
    ...
    ;function wc(a) {
        var b = sc(String(B.location.href)), c;
        (c = B.__SAPISID || B.__APISID || B.__OVERRIDE_SID) ? c = !0 : (c = new pc(document),
        c = c.get("SAPISID") || c.get("APISID") || c.get("__Secure-3PAPISID") || c.get("SID"),
        c = !!c);
        if (c && (c = (b = 0 == b.indexOf("https:") || 0 == b.indexOf("chrome-extension:") || 0 == b.indexOf("moz-extension:")) ? B.__SAPISID : B.__APISID,
        c || (c = new pc(document),
        c = c.get(b ? "SAPISID" : "APISID") || c.get("__Secure-3PAPISID")),
        c)) {
            b = b ? "SAPISIDHASH" : "APISIDHASH";
            var d = String(B.location.href);
            return d && c && b ? [b, uc(sc(d), c, a || null)].join(" ") : null
        }
        return null
    }
    ;function xc() {
    ...
    xc.prototype.set = function(a, b) {
        b = void 0 === b ? !0 : b;
        0 <= a && 52 > a && 0 === a % 1 && this.i[a] != b && (this.i[a] = b,
        this.h = -1)
    }
    ;
    ...
    ;
    function yc(a) {
        -1 == a.h && (a.h = Ma(a.i, function(b, c, d) {
    ...
    function Jc() {
        if (B.Promise && B.Promise.resolve) {
            ...
            Ic = function() {
                var b = Mc;
                "function" !== typeof B.setImmediate || B.Window && B.Window.prototype && !I("Edge") && B.Window.prototype.setImmediate == B.setImmediate ? (Cc || (Cc = Dc()),
                Cc(b)) : B.setImmediate(b)
            }
    }
    var Kc = !1
      , Lc = new Ec;
    ...
    ;
    var Qc = "StopIteration"in B ? B.StopIteration : {
    ...
    r.clear = function() {
        this.j = {};
        this.l = this.i = this.h.length = 0
    }
    ;
    r.remove = function(a) {
        return Object.prototype.hasOwnProperty.call(this.j, a) ? (delete this.j[a],
        this.i--,
        this.l++,
        this.h.length > 2 * this.i && Xc(this),
        !0) : !1
    }
    ;
    function Xc(a) {
        if (a.i != a.h.length) {
            for (var b = 0, c = 0; b < a.h.length; ) {
                var d = a.h[b];
                Object.prototype.hasOwnProperty.call(a.j, d) && (a.h[c++] = d);
                b++
            }
            a.h.length = c
        }
    ...
    ;
    r.set = function(a, b) {
        Object.prototype.hasOwnProperty.call(this.j, a) || (this.i++,
        this.h.push(a),
        this.l++);
        this.j[a] = b
    }
    ...
    r.forEach = function(a, b) {
        for (var c = Wc(this), d = 0; d < c.length; d++) {
            var e = c[d]
              , f = this.get(e);
            a.call(b, f, e, this)
        }
    ...
    ;
    var Zc = !qb || 9 <= Number(Db), $c;
    if ($c = qb) {
        var ad;
        if (Object.prototype.hasOwnProperty.call(Ab, "9"))
            ad = Ab["9"];
        else {
            for (var bd = 0, cd = ab(String(zb)).split("."), dd = ab("9").split("."), ed = Math.max(cd.length, dd.length), fd = 0; 0 == bd && fd < ed; fd++) {
                var gd = cd[fd] || ""
                  , hd = dd[fd] || "";
                do {
                    var id = /(\d*)(\D*)(.*)/.exec(gd) || ["", "", "", ""]
                      , jd = /(\d*)(\D*)(.*)/.exec(hd) || ["", "", "", ""];
                    if (0 == id[0].length && 0 == jd[0].length)
                        break;
                    bd = jb(0 == id[1].length ? 0 : parseInt(id[1], 10), 0 == jd[1].length ? 0 : parseInt(jd[1], 10)) || jb(0 == id[2].length, 0 == jd[2].length) || jb(id[2], jd[2]);
                    gd = id[3];
                    hd = jd[3]
                } while (0 == bd)
            }
    ...
    var kd = $c
      , ld = function() {
        ...
        try {
            B.addEventListener("test", Aa, b),
            B.removeEventListener("test", Aa, b)
        } catch (c) {}
        return a
    }();
    function md(a, b) {
    ...
    td.prototype.add = function(a, b, c, d, e) {
        ...
        var g = ud(a, b, d, e);
        -1 < g ? (b = a[g],
        c || (b.M = !1)) : (b = new rd(b,this.src,f,!!d,e),
        b.M = c,
        a.push(b));
        return b
    }
    ...
    function vd(a, b) {
        var c = b.type;
        c in a.listeners && Oa(a.listeners[c], b) && (sd(b),
    ...
    function ud(a, b, c, d) {
        for (var e = 0; e < a.length; ++e) {
            var f = a[e];
            if (!f.J && f.listener == b && f.capture == !!c && f.O == d)
                return e
        }
        return -1
    }
    ...
    function zd(a, b, c, d, e) {
        if (d && d.once)
            ...
            c = Bd(c),
            a && a[pd] ? Cd(a, b, c, D(d) ? !!d.capture : !!d, e) : Dd(a, b, c, !1, d, e)
    }
    ...
    function Ad(a, b, c, d, e) {
        if (Array.isArray(b))
            ...
            c = Bd(c),
            a && a[pd] ? a.h.add(String(b), c, !0, D(d) ? !!d.capture : !!d, e) : Dd(a, b, c, !0, d, e)
    }
    function Id(a, b, c, d, e) {
        if (Array.isArray(b))
            ...
            (d = D(d) ? !!d.capture : !!d,
            c = Bd(c),
            a && a[pd]) ? a.h.remove(String(b), c, d, e) : a && (a = Ed(a)) && (b = a.listeners[b.toString()],
            a = -1,
            b && (a = ud(b, c, d, e)),
            (c = -1 < a ? b[a] : null) && Jd(c))
    }
    ...
    function Hd(a, b) {
        ...
        if (!Zc) {
            ...
            if (!(0 > c.keyCode || void 0 != c.returnValue)) {
                ...
                c = [];
                for (f = d.h; f; f = f.parentNode)
                    c.push(f);
                f = a.type;
                for (var g = c.length - 1; !d.i && 0 <= g; g--) {
                    d.h = c[g];
                    var h = Kd(c[g], f, !0, d);
                    e = e && h
                }
                for (g = 0; !d.i && g < c.length; g++)
                    d.h = c[g],
                    h = Kd(c[g], f, !1, d),
                    e = e && h
            }
    ...
    M.prototype.then = function(a, b, c) {
        return Td(this, "function" === typeof a ? a : null, "function" === typeof b ? b : null, c)
    }
    ;
    ...
    function Vd(a, b) {
        if (0 == a.h)
            if (a.j) {
                var c = a.j;
                if (c.i) {
                    for (var d = 0, e = null, f = null, g = c.i; g && (g.j || (d++,
                    g.h == a && (e = g),
                    !(e && 1 < d))); g = g.next)
                        e || (f = g);
                    e && (0 == c.h && 1 == d ? Vd(c, b) : (f ? (d = f,
                    d.next == c.l && (c.l = d),
                    d.next = d.next.next) : Wd(c),
                    Xd(c, e, 3, b)))
                }
                a.j = null
            } else
    ...
    function Yd(a, b) {
        a.i || 2 != a.h && 3 != a.h || Zd(a);
        a.l ? a.l.next = b : a.i = b;
        a.l = b
    }
    function Td(a, b, c, d) {
        var e = Sd(null, null, null);
    ...
    function Xd(a, b, c, d) {
        ...
        if (b.h)
            ...
            try {
                b.j ? b.i.call(b.context) : be(b, c, d)
            } catch (e) {
                ce.call(null, e)
            }
        Ac(Rd, b)
    ...
    ge.prototype.set = function(a, b) {
        void 0 === b ? this.h.remove(a) : this.h.set(a, Od(b))
    }
    ;
    ...
    ;
    ge.prototype.remove = function(a) {
        this.h.remove(a)
    }
    ;
    function he(a) {
    ...
    function je(a) {
        return void 0 === a || a instanceof ie ? a : new ie(a)
    }
    he.prototype.set = function(a, b) {
        he.B.set.call(this, a, je(b))
    }
    ;
    he.prototype.i = function(a) {
        a = he.B.get.call(this, a);
    ...
    ke.prototype.set = function(a, b, c) {
        if (b = je(b)) {
            if (c) {
                if (c < Date.now()) {
                    ke.prototype.remove.call(this, a);
                    return
                }
                b.expiration = c
            }
        ...
        ke.B.set.call(this, a, b)
    }
    ;
    ke.prototype.i = function(a) {
        var b = ke.B.i.call(this, a);
        if (b) {
            var c = b.creation
              , d = b.expiration;
    ...
    r.isAvailable = function() {
        if (!this.h)
            return !1;
        try {
            return this.h.setItem("__sak", "1"),
            this.h.removeItem("__sak"),
            !0
        } catch (a) {
            return !1
        }
    ...
    function pe(a, b) {
        ...
        if (qb && !(9 <= Number(Db))) {
            qe || (qe = new Vc);
            this.h = qe.get(a);
            this.h || (b ? this.h = document.getElementById(b) : (this.h = document.createElement("userdata"),
    ...
    ;
    r.set = function(a, b) {
        this.h.setAttribute(se(a), b);
        te(this)
    }
    ;
    r.get = function(a) {
        a = this.h.getAttribute(se(a));
        if ("string" !== typeof a && null !== a)
            throw "Storage mechanism: Invalid value was encountered";
        return a
    }
    ...
    ;
    r.clear = function() {
        for (var a = this.h.XMLDocument.documentElement, b = a.attributes.length; 0 < b; b--)
    ...
    ue.prototype.C = function(a) {
        var b = this.i.C(!0)
          ...
          , d = new Rc;
        d.next = function() {
            for (var e = b.next(); e.substr(0, c.h.length) != c.h; )
                e = b.next();
    ...
    ;
    var ve = window.yt && window.yt.config_ || window.ytcfg && window.ytcfg.data_ || {};
    E("yt.config_", ve);
    function we(a) {
        var b = arguments;
        1 < b.length ? ve[b[0]] = b[1] : 1 === b.length && Object.assign(ve, b[0])
    }
    function P(a, b) {
        return a in ve ? ve[a] : b
    }
    ;var xe = [];
    function ye(a) {
        xe.forEach(function(b) {
            return b(a)
        })
    }
    function ze(a) {
    ...
    function Ae(a) {
        ...
        b ? b(a, "ERROR", void 0, void 0, void 0) : (b = P("ERRORS", []),
        b.push([a, "ERROR", void 0, void 0, void 0]),
        we("ERRORS", b))
    }
    function Be(a) {
        var b = C("yt.logging.errors.log");
        b ? b(a, "WARNING", void 0, void 0, void 0) : (b = P("ERRORS", []),
        b.push([a, "WARNING", void 0, void 0, void 0]),
        we("ERRORS", b))
    }
    ;var Ce = 0;
    E("ytDomDomGetNextId", C("ytDomDomGetNextId") || function() {
        return ++Ce
    }
    );
    var De = {
    ...
    ;
    var Va = B.ytEventsEventsListeners || {};
    E("ytEventsEventsListeners", Va);
    var Fe = B.ytEventsEventsCounter || {
        count: 0
    };
    E("ytEventsEventsCounter", Fe);
    function Ge(a, b, c, d) {
        d = void 0 === d ? {} : d;
        ...
        G(a, function(b) {
            if (b in Va) {
                var c = Va[b]
                  ...
                  , f = c[3];
                c = c[4];
                d.removeEventListener ? Ie() || "boolean" === typeof c ? d.removeEventListener(e, f, c) : d.removeEventListener(e, f, !!c.capture) : d.detachEvent && d.detachEvent("on" + e, f);
                delete Va[b]
            }
        }))
    }
    ...
    function Je(a, b, c) {
        ...
        if (a && (a.addEventListener || a.attachEvent)) {
            ...
            if (!e) {
                ...
                var g = f ? function(h) {
                    h = new Ee(h);
                    if (!Mb(h.relatedTarget, function(k) {
                        return k == a
                    }))
                ...
                Ie() || "boolean" === typeof d ? a.addEventListener(b, g, d) : a.addEventListener(b, g, !!d.capture)) : a.attachEvent("on" + b, g);
                Va[e] = [a, b, c, g, d]
            }
        }
    }
    ;function Ke(a, b) {
        "function" === typeof a && (a = ze(a));
        ...
        for (var c = a.split(b), d = {}, e = 0, f = c.length; e < f; e++) {
            ...
            if (1 == g.length && g[0] || 2 == g.length)
                try {
                    var h = Pe(g[0] || "")
                      , k = Pe(g[1] || "");
                    h in d ? Array.isArray(d[h]) ? Ra(d[h], k) : d[h] = [d[h], k] : d[h] = k
                } catch (p) {
                    var l = p
                      , m = g[0]
                      , n = String(Oe);
                    l.args = [{
                        ...
                        value: g[1],
                        query: a,
                        method: Qe == n ? "unchanged" : n
                    }];
                    Ne.hasOwnProperty(m) || ("ReferenceError" === l.name ? Be(l) : Ae(l))
                }
        }
        return d
    }
    ...
    ;var Ue = {};
    function Ve(a) {
        return Ue[a] || (Ue[a] = String(a).replace(/\-([a-z])/g, function(b, c) {
    ...
    ;var We = {}
      ...
      , Ye = {};
    function Ze() {
        for (var a = u(Xe), b = a.next(); !b.done; b = a.next())
            b = b.value,
            b()
    }
    function $e(a, b) {
        var c;
        "yt:" == a.tagName.toLowerCase().substr(0, 3) ? c = a.getAttribute(b) : c = a ? a.dataset ? a.dataset[Ve(b)] : a.getAttribute("data-" + b) : null;
        return c
    }
    function af(a, b) {
        ee.I.apply(ee, arguments)
    }
    ;function bf(a) {
        this.i = a || {};
        this.j = this.h = !1;
        a = document.getElementById("www-widgetapi-script");
        if (this.h = !!("https:" == document.location.protocol || a && 0 == a.src.indexOf("https:"))) {
    ...
    function Q(a, b) {
        for (var c = [a.i, window.YTConfig || {}], d = 0; d < c.length; d++) {
            var e = c[d][b];
            if (void 0 != e)
                return e
        }
    ...
    function cf(a, b, c) {
        df || (df = {},
        Je(window, "message", Ha(a.l, a)));
        df[c] = b
    }
    bf.prototype.l = function(a) {
        if (a.origin == Q(this, "host") || a.origin == Q(this, "host").replace(/^http:/, "https:")) {
            try {
            ...
            this.j = !0;
            this.h || 0 != a.origin.indexOf("https:") || (this.h = !0);
            if (a = df[b.id])
                a.u = !0,
                a.u && (G(a.s, a.U, a),
                a.s.length = 0),
    ...
    ;
    kf.i();
    var mf = B.ytPubsubPubsubInstance || new O
      , nf = B.ytPubsubPubsubSubscribedKeys || {}
      , of = B.ytPubsubPubsubTopicToKeys || {}
      , pf = B.ytPubsubPubsubIsSynchronous || {};
    O.prototype.subscribe = O.prototype.subscribe;
    O.prototype.unsubscribeByKey = O.prototype.L;
    O.prototype.publish = O.prototype.I;
    O.prototype.clear = O.prototype.clear;
    E("ytPubsubPubsubInstance", mf);
    E("ytPubsubPubsubTopicToKeys", of);
    E("ytPubsubPubsubIsSynchronous", pf);
    E("ytPubsubPubsubSubscribedKeys", nf);
    var S = window
      , T = S.ytcsi && S.ytcsi.now ? S.ytcsi.now : S.performance && S.performance.timing && S.performance.now && S.performance.timing.navigationStart ? function() {
        return S.performance.timing.navigationStart + S.performance.now()
    }
    : function() {
        return (new Date).getTime()
    }
    ;
    var qf = ff("initial_gel_batch_timeout", 1E3)
      , rf = Math.pow(2, 16) - 1
      , sf = null
      , tf = 0
      , uf = void 0
      ...
      , xf = 0
      , yf = !0
      , zf = B.ytLoggingTransportGELQueue_ || new Map;
    E("ytLoggingTransportGELQueue_", zf);
    var Af = B.ytLoggingTransportTokensToCttTargetIds_ || {};
    ...
    function Df() {
        R("web_gel_timeout_cap") && !wf && (wf = Ke(Bf, 6E4));
        window.clearTimeout(vf);
        var a = P("LOGGING_BATCH_TIMEOUT", ff("web_gel_debounce_ms", 1E4));
        R("shorten_initial_gel_batch_timeout") && yf && (a = qf);
        vf = Ke(Bf, a)
    }
    function Cf(a, b) {
        var c = uf;
        b = void 0 === b ? !1 : b;
        for (var d = Math.round(T()), e = zf.size, f = u(zf), g = f.next(); !g.done; g = f.next()) {
            var h = u(g.value);
            g = h.next().value;
            var k = h.next().value;
            h = Xa({
    ...
    function Hf(a, b) {
        ...
        if (c) {
            ...
            !d && R("web_client_counter_random_seed") && (d = Math.floor(Math.random() * rf / 2));
            d++;
            d > rf && (d = 1);
            we("BATCH_CLIENT_COUNTER", d);
            c = {
                serializedEventId: c,
                clientCounter: String(d)
            };
            a.serializedClientEventId = c;
            sf && tf && R("log_gel_rtt_web") && (a.previousBatchInfo = {
    ...
    ;var Jf = B.ytLoggingGelSequenceIdObj_ || {};
    E("ytLoggingGelSequenceIdObj_", Jf);
    function Kf(a) {
        var b = Lf;
        ...
        e.u_his = h;
        e.u_java = !!J.navigator && "unknown" !== typeof J.navigator.javaEnabled && !!J.navigator.javaEnabled && J.navigator.javaEnabled();
        J.screen && (e.u_h = J.screen.height,
        e.u_w = J.screen.width,
        e.u_ah = J.screen.availHeight,
        e.u_aw = J.screen.availWidth,
        e.u_cd = J.screen.colorDepth);
        J.navigator && J.navigator.plugins && (e.u_nplug = J.navigator.plugins.length);
        J.navigator && J.navigator.mimeTypes && (e.u_nmime = J.navigator.mimeTypes.length);
        h = b.h;
        try {
            var k = h.screenX;
            var l = h.screenY
        ...
        k = [h.screenLeft, h.screenTop, k, l, h.screen ? h.screen.availWidth : void 0, h.screen ? h.screen.availTop : void 0, m, n, p, q];
        l = b.h.top;
        try {
            var v = (l || window).document
              , w = "CSS1Compat" == v.compatMode ? v.documentElement : v.body;
            var y = (new Kb(w.clientWidth,w.clientHeight)).round()
        } catch (N) {
            y = new Kb(-12245933,-12245933)
        }
        v = y;
        y = {};
        w = new xc;
        B.SVGElement && B.document.createElementNS && w.set(0);
        l = Xb();
        l["allow-top-navigation-by-user-activation"] && w.set(1);
        l["allow-popups-to-escape-sandbox"] && w.set(2);
        B.crypto && B.crypto.subtle && w.set(3);
        B.TextDecoder && B.TextEncoder && w.set(4);
        w = yc(w);
        y.bc = w;
        y.bih = v.height;
        y.biw = v.width;
    ...
    var Mf = "XMLHttpRequest"in B ? function() {
    ...
    ;var Of = {
      ...
      , Pf = "app debugcss debugjs expflag force_ad_params force_viral_ad_response_params forced_experiments innertube_snapshots innertube_goldens internalcountrycode internalipoverride absolute_experiments conditional_experiments sbb sr_bns_address client_dev_root_url".split(" ")
      , Qf = !1;
    function Rf(a, b) {
        b = void 0 === b ? {} : b;
        if (!c)
            var c = window.location.href;
        var d = a.match(Nb)[1] || null
          , e = K(a);
        d && e ? (d = c,
        c = a.match(Nb),
        d = d.match(Nb),
        c = c[3] == d[3] && c[1] == d[1] && c[4] == d[4]) : c = e ? K(c) == e && (Number(c.match(Nb)[4] || null) || null) == (Number(a.match(Nb)[4] || null) || null) : !0;
        d = R("web_ajax_ignore_global_headers_if_set");
        for (var f in Of)
            e = P(Of[f]),
            !e || !c && K(a) || d && void 0 !== b[f] || (b[f] = e);
        if (c || !K(a))
            b["X-YouTube-Utc-Offset"] = String(-(new Date).getTimezoneOffset());
        (c || !K(a)) && (f = "undefined" != typeof Intl ? (new Intl.DateTimeFormat).resolvedOptions().timeZone : null) && (b["X-YouTube-Time-Zone"] = f);
        if (c || !K(a))
            b["X-YouTube-Ad-Signals"] = Re(Kf(void 0));
        return b
    }
    function Sf(a) {
        var b = window.location.search
          , c = K(a)
          , d = Ob(a.match(Nb)[5] || null);
    ...
    function Tf(a, b) {
        if (window.fetch && "XML" != b.format) {
            ...
            b.ba && 0 < b.timeout && (f = Ke(function() {
                e || (e = !0,
                window.clearTimeout(f),
                b.ba.call(b.context || B))
            }, b.timeout))
        } else
            Wf(a, b)
    }
    ...
    function Uf(a, b) {
        b.Ta && (a = document.location.protocol + "//" + document.location.hostname + (document.location.port ? ":" + document.location.port : "") + a);
    ...
    function Vf(a, b) {
        var c = P("XSRF_FIELD_NAME", void 0), d = P("XSRF_TOKEN", void 0), e = b.postBody || "", f = b.A, g = P("XSRF_FIELD_NAME", void 0), h;
        b.headers && (h = b.headers["Content-Type"]);
        b.Sa || K(a) && !b.withCredentials && K(a) != document.location.hostname || "POST" != b.method || h && "application/x-www-form-urlencoded" != h || b.A && b.A[g] || (f || (f = {}),
        f[c] = d);
        f && "string" === typeof e && (e = Se(e),
        Za(e, f),
        e = b.da && "JSON" == b.da ? JSON.stringify(e) : Rb(e));
        if (!(c = e) && (c = f)) {
            a: {
                for (var k in f) {
                    f = !1;
        ...
        !Qf && c && "POST" != b.method && (Qf = !0,
        Ae(Error("AJAX request with postData should use POST")));
        return e
    }
    function Yf(a, b, c, d) {
        var e = null;
        ...
        case "JSON":
            ...
            break;
        case "XML":
            if (a = (a = c.responseXML) ? Zf(a) : null)
                e = {},
    ...
    function Xf(a, b, c, d, e, f, g) {
        function h() {
            4 == (k && "readyState"in k ? k.readyState : 0) && b && ze(b)(k)
        }
        c = void 0 === c ? "GET" : c;
        d = void 0 === d ? "" : d;
        var k = Nf();
        ...
        R("debug_forward_web_query_parameters") && (a = Sf(a));
        k.open(c, a, !0);
        f && (k.responseType = f);
    ...
    ;function bg() {
        return "INNERTUBE_API_KEY"in ve && "INNERTUBE_API_VERSION"in ve
    }
    function Ff() {
        return {
            innertubeApiKey: P("INNERTUBE_API_KEY", void 0),
            innertubeApiVersion: P("INNERTUBE_API_VERSION", void 0),
            ma: P("INNERTUBE_CONTEXT_CLIENT_CONFIG_INFO"),
            na: P("INNERTUBE_CONTEXT_CLIENT_NAME", "WEB"),
            innertubeContextClientVersion: P("INNERTUBE_CONTEXT_CLIENT_VERSION", void 0),
            pa: P("INNERTUBE_CONTEXT_HL", void 0),
            oa: P("INNERTUBE_CONTEXT_GL", void 0),
            qa: P("INNERTUBE_HOST_OVERRIDE", void 0) || "",
            sa: !!P("INNERTUBE_USE_THIRD_PARTY_AUTH", !1),
            ra: !!P("INNERTUBE_OMIT_API_KEY_WHEN_AUTH_HEADER_IS_PRESENT", !1),
            appInstallData: P("SERIALIZED_CLIENT_CONFIG_DATA", void 0)
        }
    }
    function Ef(a) {
        var b = {
        ...
        c = [];
        var d = P("EXPERIMENTS_FORCED_FLAGS", {});
        for (e in d)
            c.push({
                key: e,
                value: String(d[e])
            });
        var e = P("EXPERIMENT_FLAGS", {});
        for (var f in e)
        ...
        a.appInstallData && R("web_log_app_install_experiments") && (b.client.configInfo = b.client.configInfo || {},
        ...
        e = b.client;
        c = {};
        d = u(Object.entries(Se(P("DEVICE", ""))));
    ...
    function cg(a, b, c) {
        ...
        if (b && b.includes("www.youtube-nocookie.com"))
            return d;
        (b = c.Ma || P("AUTHORIZATION")) || (a ? b = "Bearer " + C("gapi.auth.getToken")().La : b = wc([]));
        b && (d.Authorization = b,
        d["X-Goog-AuthUser"] = P("SESSION_INDEX", 0),
        R("pageid_as_header_web") && (d["X-Goog-PageId"] = P("DELEGATED_SESSION_ID")));
        return d
    }
    ;function dg(a) {
        a = Object.assign({}, a);
    ...
    ;function eg(a) {
        var b = new oe;
        (b = b.isAvailable() ? a ? new ue(b,a) : b : null) || (a = new pe(a || "UserDataSharedStore"),
        b = a.isAvailable() ? a : null);
        this.h = (a = b) ? new ke(a) : null;
        this.i = document.domain || window.location.hostname
    }
    eg.prototype.set = function(a, b, c, d) {
        c = c || 31104E3;
        this.remove(a);
        if (this.h)
            try {
    ...
    eg.prototype.get = function(a, b) {
        ...
        if (d && (c = qc.get("" + a, void 0)) && (c = unescape(c),
        b))
            try {
                c = JSON.parse(c)
            } catch (e) {
    ...
    eg.prototype.remove = function(a) {
        ...
        var b = this.i;
        qc.remove("" + a, "/", void 0 === b ? "youtube.com" : b)
    }
    ;
    var fg;
    function gg() {
        fg || (fg = new eg("yt.innertube"));
        return fg
    }
    function hg(a, b, c, d) {
        if (d)
        ...
        gg().set("nextId", d + 1, 86400, !0);
        gg().set("requests", e, 86400, !0);
        return d
    }
    function ig(a) {
        var b = gg().get("requests", !0) || {};
        delete b[a];
        gg().set("requests", b, 86400, !0)
    }
    function jg(a) {
        var b = gg().get("requests", !0);
        if (b) {
    ...
    ;var kg = C("ytPubsub2Pubsub2Instance") || new O;
    O.prototype.subscribe = O.prototype.subscribe;
    O.prototype.unsubscribeByKey = O.prototype.L;
    O.prototype.publish = O.prototype.I;
    O.prototype.clear = O.prototype.clear;
    E("ytPubsub2Pubsub2Instance", kg);
    E("ytPubsub2Pubsub2SubscribedKeys", C("ytPubsub2Pubsub2SubscribedKeys") || {});
    ...
    x(U, Error);
    var pg = {}
      , qg = (pg.AUTH_INVALID = "No user identifier specified.",
    pg.EXPLICIT_ABORT = "Transaction was explicitly aborted.",
    pg.IDB_NOT_SUPPORTED = "IndexedDB is not supported.",
    pg.MISSING_OBJECT_STORE = "Object store not created.",
    pg.UNKNOWN_ABORT = "Transaction was aborted for unknown reasons.",
    pg.QUOTA_EXCEEDED = "The current transaction exceeded its quota limitations.",
    pg.QUOTA_MAYBE_EXCEEDED = "The current transaction may have failed because of exceeding quota limitations.",
    pg);
    function V(a, b, c) {
        b = void 0 === b ? {} : b;
        c = void 0 === c ? qg[a] : c;
    ...
    x(V, U);
    function rg(a) {
        V.call(this, "MISSING_OBJECT_STORE", {
            Ua: a
        }, qg.MISSING_OBJECT_STORE);
    ...
    W.all = function(a) {
        return new W(function(b, c) {
            ...
            ++f.G)
                ug(W.resolve(a[f.G]).then(function(g) {
                    return function(h) {
                        d[g.G] = h;
                        e--;
                        0 === e && b(d)
    ...
    W.prototype.then = function(a, b) {
        var c = this
          , d = null !== a && void 0 !== a ? a : tg
          , e = null !== b && void 0 !== b ? b : sg;
        return new W(function(f, g) {
            ...
            c.onRejected.push(function() {
                wg(c, c, e, f, g)
            })) : "FULFILLED" === c.state.status ? vg(c, c, d, f, g) : "REJECTED" === c.state.status && wg(c, c, e, f, g)
        }
        )
    }
    ;
    ...
    function vg(a, b, c, d, e) {
        try {
            ...
            f instanceof W ? xg(a, b, f, d, e) : d(f)
        } catch (g) {
            e(g)
        }
    }
    ...
    r.add = function(a, b, c) {
        return Cg(this, [a], "readwrite", function(d) {
            return Dg(d, a).add(b, c)
        })
    }
    ;
    r.clear = function(a) {
        return Cg(this, [a], "readwrite", function(b) {
            return Dg(b, a).clear()
        })
    }
    ;
    ...
    r.count = function(a, b) {
        return Cg(this, [a], "readonly", function(c) {
            return Dg(c, a).count(b)
        })
    }
    ;
    r["delete"] = function(a, b) {
        return Cg(this, [a], "readwrite", function(c) {
            return Dg(c, a)["delete"](b)
        })
    }
    ;
    r.get = function(a, b) {
    ...
    function Cg(a, b, c, d) {
        ...
        a.transactionCount++;
        var e = a.h.transaction(b, c);
        d = Eg(e, d)["catch"](function(f) {
            var g = a.h.name
              , h = b.join();
            f instanceof V || f instanceof U || ("QuotaExceededError" === f.name ? f = new V("QUOTA_EXCEEDED",{
                objectStoreNames: h,
                dbName: g
            }) : Hb && "UnknownError" === f.name ? f = new V("QUOTA_MAYBE_EXCEEDED",{
                objectStoreNames: h,
                dbName: g
    ...
    function Fg(a, b, c, d) {
        Ja(a, function f() {
            ...
            return wa(f, function(p) {
                if (1 == p.h)
                    return g = Math.round(T()),
                    p.l = 2,
                    z(p, b, 4);
                2 != p.h ? (h = Math.round(T()),
                Gg(k, !0, c, h - g),
                p.h = 0,
                p.l = 0) : (l = qa(p),
                m = Math.round(T()),
                n = m - g,
                l instanceof V && ("QUOTA_EXCEEDED" === l.type || "QUOTA_MAYBE_EXCEEDED" === l.type) && og("QUOTA_EXCEEDED", {
                    dbName: k.h.name,
                    objectStoreNames: c,
                    transactionCount: k.transactionCount,
                    transactionMode: d
                }),
                l instanceof V && "UNKNOWN_ABORT" === l.type && (og("TRANSACTION_UNEXPECTEDLY_ABORTED", {
                    objectStoreNames: c,
                    transactionDuration: n,
                    transactionCount: k.transactionCount,
                    dbDuration: m - k.j
                }),
                k.i = !0),
    ...
    r["delete"] = function(a) {
        return a instanceof IDBKeyRange ? Ig(this, a) : X(this.h["delete"](a))
    }
    ;
    r.get = function(a) {
    ...
    ;
    Kg.prototype.getKey = function(a) {
    ...
    function Lg(a) {
        return X(a).then(function(b) {
            return null === b ? null : new Pg(a,b)
        })
    }
    r = Pg.prototype;
    r.advance = function(a) {
        this.cursor.advance(a);
        return Lg(this.request)
    }
    ;
    ...
    function Qg(a, b, c) {
        return Ja(this, function e() {
            var f, g, h, k, l, m, n, p, q, v;
            return wa(e, function(w) {
                if (1 == w.h)
                    return f = self.indexedDB.open(a, b),
                    g = c,
                    h = g.blocked,
                    k = g.blocking,
                    l = g.xa,
                    ...
                    ,
                    f.addEventListener("upgradeneeded", function(y) {
                        if (null === y.newVersion)
                        ...
                        y.dataLoss && "none" !== y.dataLoss && og("IDB_DATA_CORRUPTED", {
                            reason: y.dataLossMessage || "unknown reason",
                            dbName: a
                        });
                        var N = q()
                          , ea = new Mg(f.transaction);
                        m && m(N, y.oldVersion, y.newVersion, ea)
                    }),
                    ...
                    z(w, zg(f), 2);
                v = w.m;
                k && v.addEventListener("versionchange", function() {
                    k(q())
                });
                v.addEventListener("close", function() {
                    og("IDB_UNEXPECTEDLY_CLOSED", {
                        dbName: a,
                        dbVersion: v.version
                    });
                    l && l()
    ...
    Sg.prototype["delete"] = function(a) {
        a = void 0 === a ? {} : a;
        return Rg(this.name, a)
    }
    ;
    Sg.prototype.open = function() {
        var a = this;
        if (!this.h) {
            var b, c = function() {
                a.h === b && (a.h = void 0)
                ...
                return Ja(a, function g() {
                    var h = this, k, l, m;
                    return wa(g, function(n) {
                        switch (n.h) {
                        case 1:
                            return n.l = 2,
                            z(n, Tg(h.name, h.options.version, d), 4);
                        case 4:
                            k = n.m;
                            if (!Eb) {
                                n.h = 5;
                            ...
                            a: {
                                var p = u(Object.keys(h.options.wa));
                                for (var q = p.next(); !q.done; q = p.next())
                                    if (q = q.value,
                                    !k.h.objectStoreNames.contains(q)) {
                                        p = q;
                                        break a
                                    }
                                p = void 0
                        ...
                        case 2:
                            m = qa(n);
                            if (m instanceof DOMException ? "VersionError" === m.name : "DOMError"in self && m instanceof DOMError ? "VersionError" === m.name : m instanceof Object && "message"in m && "An attempt was made to open a database using a lower version than the existing version." === m.message)
                                return n["return"](Tg(h.name, void 0, Object.assign(Object.assign({}, d), {
                                    upgrade: void 0
                                })));
                            c();
                            throw m;
    ...
    function Vg(a) {
        return Ja(this, function c() {
            ...
            return wa(c, function(e) {
                if (1 == e.h)
                    return z(e, Ug.open(), 2);
                d = e.m;
                return e["return"](Cg(d, ["databases"], "readwrite", function(f) {
                    var g = Dg(f, "databases");
                    return g.get(a.actualName).then(function(h) {
                        if (h ? a.actualName !== h.actualName || a.publicName !== h.publicName || a.userIdentifier !== h.userIdentifier || a.signedIn !== h.signedIn || a.clearDataOnAuthChange !== h.clearDataOnAuthChange : 1)
    ...
    function Wg() {
        return Ja(this, function b() {
            var c;
            return wa(b, function(d) {
                if (1 == d.h)
                    return z(d, Ug.open(), 2);
                c = d.m;
        ...
        return Ja(this, function b() {
            ...
            return wa(b, function(e) {
                ...
                case 1:
                    ...
                    f && (f = /WebKit\/([0-9]+)/.exec(H),
                    f = !(f && 602 <= parseInt(f[1], 10)));
                    if (f && !R("ytidb_allow_on_ios_safari_v8_and_v9") || rb)
                        return e["return"](!1);
                    try {
                        if (c = self,
    ...
    function eh(a) {
        window.addEventListener("online", function() {
            a.l = !0;
            a.i && a.dispatchEvent("ytnetworkstatus-online");
            fh(a);
            if (a.s && R("offline_error_handling")) {
                var b = ah().get("errors", !0);
                if (b) {
                    for (var c in b)
                        if (b[c]) {
    ...
    function dh(a) {
        window.addEventListener("offline", function() {
            a.l = !1;
            a.i && a.dispatchEvent("ytnetworkstatus-offline");
            fh(a)
        })
    }
    function fh(a) {
        a.u && (Be(new U("NetworkStatusManager state did not match poll",T() - 0)),
        a.u = !1)
    }
    ;function gh(a) {
        a = void 0 === a ? {} : a;
        ...
        a.ua && (this.i.s = !0);
        a.R ? (this.R = a.R,
        Cd(this.i, "ytnetworkstatus-online", function() {
            hh(b, "publicytnetworkstatus-online")
        }),
        Cd(this.i, "ytnetworkstatus-offline", function() {
            hh(b, "publicytnetworkstatus-offline")
        })) : (Cd(this.i, "ytnetworkstatus-online", function() {
    ...
    function hh(a, b) {
        a.R ? a.l ? (lf(a.u),
        a.u = hf(function() {
            a.s !== b && (a.dispatchEvent(b),
            a.s = b,
            a.l = T())
        }, a.R - (T() - a.l))) : (a.dispatchEvent(b),
        a.s = b,
        a.l = T()) : a.dispatchEvent(b)
    }
    ;var ih;
    function jh(a, b) {
        b = void 0 === b ? {} : b;
        Zg().then(function() {
            ...
            ih.i.l !== ch() && Be(new U("NetworkStatusManager isOnline does not match window status"));
            Wf(a, b)
        })
    }
    function kh(a, b) {
    ...
    ;function lh(a) {
        var b = this;
        this.h = null;
        a ? this.h = a : bg() && (this.h = Ff());
        jf(function() {
            jg(b)
        }, 0, 5E3)
    }
    lh.prototype.isReady = function() {
        !this.h && bg() && (this.h = Ff());
        return !!this.h
    }
    ;
    function If(a, b, c, d) {
        !P("VISITOR_DATA") && "visitor_id" !== b && .01 > Math.random() && Be(new U("Missing VISITOR_DATA when sending innertube request.",b,c,d));
        if (!a.isReady()) {
            var e = new U("innertube xhrclient not ready",b,c,d);
            Ae(e);
            throw e;
        }
        var f = {
        ...
        a.h.ra && f.headers.Authorization || (l.key = a.h.innertubeApiKey);
        var m = Te("" + g + e, l || {}, !0);
        Zg().then(function(n) {
            if (d.retry && R("retry_web_logging_batches") && "www.youtube-nocookie.com" != g) {
                if (R("networkless_gel") && !n || !R("networkless_gel"))
                    var p = hg(b, c, k, h);
                if (p) {
                    var q = f.onSuccess
                      , v = f.aa;
                    f.onSuccess = function(w, y) {
                        ig(p);
                        q(w, y)
                    }
                    ;
            ...
            try {
                R("use_fetch_for_op_xhr") ? Tf(m, f) : R("networkless_gel") && d.retry ? (f.method = "POST",
                !d.za && R("nwl_send_fast_on_unload") ? kh(m, f) : jh(m, f)) : (f.method = "POST",
                f.A || (f.A = {}),
                Wf(m, f))
            } catch (w) {
                if ("InvalidAccessError" == w.name)
                    p && (ig(p),
                    p = 0),
                    Be(Error("An extension is blocking network request."));
                else
                    throw w;
            }
            p && jf(function() {
    ...
    ;function mh(a, b) {
        var c = void 0 === c ? {} : c;
        var d = lh;
        P("ytLoggingEventsDefaultDisabled", !1) && lh == lh && (d = null);
        var e = c;
        e = void 0 === e ? {} : e;
        c = {};
        c.eventTimeMs = Math.round(e.timestamp || T());
        c[a] = b;
        var f = C("_lact", window);
        f = null == f ? -1 : Math.max(Date.now() - f, 0);
        c.context = {
            lastActivityMs: String(e.timestamp || !isFinite(f) ? -1 : f)
        };
        if (R("log_sequence_info_on_gel_web") && e.fa) {
            f = c.context;
            var g = e.fa;
            Jf[g] = g in Jf ? Jf[g] + 1 : 0;
            f.sequence = {
                index: Jf[g],
                groupKey: g
            };
        ...
        f = "";
        e && (f = {},
        e.videoId ? f.videoId = e.videoId : e.playlistId && (f.playlistId = e.playlistId),
        Af[e.token] = f,
        f = e.token);
        e = zf.get(f) || [];
        zf.set(f, e);
        e.push(c);
        d && (uf = new d);
        d = ff("web_logging_max_batch") || 100;
        c = T();
        e.length >= d ? Bf(!0) : 10 <= c - xf && (Df(),
        xf = c)
    }
    ;var nh = [{
        Z: function(a) {
    ...
    function oh(a) {
        for (var b = u(nh), c = b.next(); !c.done; c = b.next())
            if (c = c.value,
            c.T[a.name])
                for (var d = u(c.T[a.name]), e = d.next(); !e.done; e = d.next()) {
                    var f = e.value;
                    if (e = a.message.match(f.regexp)) {
                        a.params["params.error.original"] = e[0];
                        d = f.groups;
                        f = {};
                        for (var g = 0; g < d.length; g++)
                            f[d[g]] = e[g + 1],
                            a.params["params.error." + d[g]] = e[g + 1];
                        a.message = c.Z(f);
                        break
                    }
                }
    ...
    function sh(a) {
        return "msg=" + a.i.length + "&cb=" + a.h.length
    }
    ;var th = new O;
    function uh(a) {
        function b() {
    ...
    function yh(a, b) {
        var c = lc(a)
          , d = c.message || "Unknown Error"
          , e = c.name || "UnknownError"
          , f = c.stack || a.h || "Not available";
        if (f.startsWith(e + ": " + d)) {
            var g = f.split("\n");
            g.shift();
            f = g.join("\n")
        }
        g = c.lineNumber || "Not available";
        c = c.fileName || "Not available";
        if (a.hasOwnProperty("args") && a.args && a.args.length)
            for (var h = 0, k = 0; k < a.args.length; k++) {
                var l = a.args[k]
                  , m = "params." + k;
                h += m.length;
                if (l)
                    if (Array.isArray(l)) {
                        var n = b
                          , p = h;
                        for (h = 0; h < l.length && !(l[h] && (p += wh(h, l[h], m, n),
                        500 < p)); h++)
                            ;
                        h = p
                        ...
                        l) {
                            if (l[n]) {
                                ...
                                var v = l[n]
                                  , w = p;
                                q = "string" !== typeof v || "clickTrackingParams" !== q && "trackingParams" !== q ? 0 : (v = uh(atob(v.replace(/-/g, "+").replace(/_/g, "/")))) ? wh(q + ".ve", v, m, w) : 0;
                                h += q;
                                h += wh(n, l[n], m, p);
                                if (500 < h)
                                    break
    ...
    ;var zh = new Set
      , Ah = 0
      , Bh = 0
      , Ch = ["PhantomJS", "Googlebot", "TO STOP THIS SECURITY SCAN go/scan"];
    function Y(a, b, c) {
        ...
        if (a = "string" === typeof a ? c.getElementById(a) : a)
            ...
            b.host || (b.host = c ? Pb(a.src) : "https://www.youtube.com"),
            this.i = new bf(b),
            c || (b = Dh(this, a),
            this.o = a,
            ...
            a = b),
            this.h = a,
            this.h.id || (this.h.id = "widget" + Ca(this.h)),
            We[this.h.id] = this,
            window.postMessage) {
                this.l = new O;
                Eh(this);
    ...
    r.destroy = function() {
        ...
        if (this.o) {
            ...
            (a = this.h) && a.parentNode && a.parentNode.removeChild(a);
        df && (df[this.m] = null);
        this.i = null;
        a = this.h;
        for (var c in Va)
    ...
    function Dh(a, b) {
        ...
        c.setAttribute("title", "YouTube " + Q(a.i, "title"));
        (d = Q(a.i, "width")) && c.setAttribute("width", d);
        (d = Q(a.i, "height")) && c.setAttribute("height", d);
        var h = a.W();
        h.enablejsapi = window.postMessage ? 1 : 0;
        window.location.host && (h.origin = window.location.protocol + "//" + window.location.host);
        h.widgetid = a.m;
        window.location.href && G(["debugjs", "debugcss"], function(k) {
            var l = window.location.href;
            var m = l.search(Sb);
            b: {
                var n = 0;
                for (var p = k.length; 0 <= (n = l.indexOf(k, n)) && n < m; ) {
                    var q = l.charCodeAt(n - 1);
                    if (38 == q || 63 == q)
                        if (q = l.charCodeAt(n + p),
                        !q || 61 == q || 38 == q || 35 == q)
                            break b;
                    n += p + 1
                }
            ...
            if (0 > n)
                ...
                if (0 > p || p > m)
                    p = m;
                n += k.length + 1;
                l = decodeURIComponent(l.substr(n, p - n).replace(/\+/g, " "))
            }
            null !== l && (h[k] = l)
        });
        c.src = Q(a.i, "host") + ("/embed/" + Q(a.i, "videoId")) + "?" + Rb(h);
        return c
    }
    r.ca = function() {
        this.h && this.h.contentWindow ? this.U({
            event: "listening"
    ...
    function Eh(a) {
        cf(a.i, a, a.m);
        a.j = Le(Ha(a.ca, a));
        Je(a.h, "load", Ha(function() {
            window.clearInterval(this.j);
            this.j = Le(Ha(this.ca, this))
        }, a))
    }
    function Hh(a, b) {
        a.H[b] || (a.H[b] = !0,
        Ih(a, "addEventListener", [b]))
    }
    r.U = function(a) {
        a.id = this.m;
        a.channel = "widget";
        ...
        var b = this.i;
        var c = Pb(this.h.src || "");
        b = 0 == c.indexOf("https:") ? [c] : b.h ? [c.replace("http:", "https:")] : b.j ? [c] : [c, c.replace("http:", "https:")];
        if (this.h.contentWindow)
            for (c = 0; c < b.length; c++)
                try {
                    this.h.contentWindow.postMessage(a, b[c])
                } catch (n) {
                    if (n.name && "SyntaxError" == n.name) {
                        if (!(n.message && 0 < n.message.indexOf("target origin ''"))) {
                            var d = void 0
                              , e = n;
                            d = void 0 === d ? {} : d;
                            d.name = P("INNERTUBE_CONTEXT_CLIENT_NAME", 1);
                            d.version = P("INNERTUBE_CONTEXT_CLIENT_VERSION", void 0);
                            var f = d || {};
                            d = "WARNING";
                            d = void 0 === d ? "ERROR" : d;
                            if (e) {
                                ...
                                if (!(5 <= Ah || (R("kevlar_js_fixes") ? (e = oh(yh(e, f)),
                                e.params || (e.params = {}),
                                f = rh(),
                                e.params["params.errorServiceSignature"] = sh(f),
                                e.params["params.serviceWorker"] = "false",
                                e.params["params.fscripts"] = String(document.querySelectorAll("script:not([nonce])").length)) : e = oh(yh(e, f)),
                                window.yterr && "function" === typeof window.yterr && window.yterr(e),
                                f = R("kevlar_js_fixes") ? 0 === e.sampleWeight : 0 <= e.stack.indexOf("/YouTubeCenter.js") || 0 <= e.stack.indexOf("/mytube.js"),
                                zh.has(e.message) || f))) {
                                    "ERROR" === d ? (th.I("handleError", e),
                                    R("record_app_crashed_web") && 0 === Bh && mh("appCrashed", {
                                        appCrashType: "APP_CRASH_TYPE_BREAKPAD"
                                    }),
                                    Bh++) : "WARNING" === d && th.I("handleWarning", e);
                                    if (R("kevlar_gel_error_routing")) {
                                        ...
                                        a: {
                                            ...
                                            for (var k = f.next(); !k.done; k = f.next()) {
                                                var l = H;
                                                if (l && 0 <= l.toLowerCase().indexOf(k.value.toLowerCase())) {
                                                    f = !0;
                                                    break a
                                                }
                                            }
                                        ...
                                        if (!f) {
                                            ...
                                            g.fileName && (k.filename = g.fileName);
                                            f = g.lineNumber && g.lineNumber.split ? g.lineNumber.split(":") : [];
                                            0 !== f.length && (1 !== f.length || isNaN(Number(f[0])) ? 2 !== f.length || isNaN(Number(f[0])) || isNaN(Number(f[1])) || (k.lineNumber = Number(f[0]),
                                            k.columnNumber = Number(f[1])) : k.lineNumber = Number(f[0]));
                                            f = {
                                                level: "ERROR_LEVEL_UNKNOWN",
                                                message: g.message,
                                                errorClassName: g.name,
                                                sampleWeight: g.sampleWeight
                                            };
                                            "ERROR" === h ? f.level = "ERROR_LEVEL_ERROR" : "WARNING" === h && (f.level = "ERROR_LEVEL_WARNNING");
                                            h = {
                                                isObfuscated: !0,
                                                browserStackInfo: k
                                            };
                                            ...
                                            P("FEXP_EXPERIMENTS") && (k.experimentIds = P("FEXP_EXPERIMENTS"));
                                            k.kvPairs = R("kevlar_js_fixes") ? [] : [{
                                                key: "client.params.errorServiceSignature",
                                                value: sh(rh())
                                            }, {
                                                key: "client.params.serviceWorker",
                                                value: "false"
                                            }];
                                            if (g = g.params) {
                                                l = u(Object.keys(g));
                                            ...
                                            g = P("SERVER_NAME", void 0);
                                            l = P("SERVER_VERSION", void 0);
                                            g && l && (k.kvPairs.push({
                                                key: "server.name",
                                                value: g
                                            }),
                                    ...
                                    if (!R("suppress_error_204_logging")) {
                                        g = e;
                                        f = g.params || {};
                                        d = {
                                            ya: {
                                        ...
                                        f.version && (d["client.version"] = f.version);
                                        if (d.A) {
                                            g.stack && (d.A.stack = g.stack);
                                            g = u(Object.keys(f));
                                            for (h = g.next(); !h.done; h = g.next())
                                                h = h.value,
                                                d.A["client." + h] = f[h];
                                            if (f = P("LATEST_ECATCHER_SERVICE_TRACKING_PARAMS", void 0))
                                                for (g = u(Object.keys(f)),
                                                h = g.next(); !h.done; h = g.next())
                                                    h = h.value,
                                                    d.A[h] = f[h];
                                            f = P("SERVER_NAME", void 0);
                                            g = P("SERVER_VERSION", void 0);
                                            f && g && (d.A["server.name"] = f,
                                            d.A["server.version"] = g)
                                        }
                                        Wf(P("ECATCHER_REPORT_HOST", "") + "/error_204", d)
                                    }
                                    zh.add(e.message);
                                    Ah++
                                }
    ...
    function Mh(a, b) {
        G(b, function(c) {
            ...
            : Jh(c) ? this[c] = function() {
                this.playerInfo = {};
                this.D = {};
                Ih(this, c, arguments);
                return this
            }
            : Kh(c) ? this[c] = function() {
                var d = 0;
    ...
    r.getVideoEmbedCode = function() {
        var a = parseInt(Q(this.i, "width"), 10)
          , b = parseInt(Q(this.i, "height"), 10)
          , c = Q(this.i, "host") + ("/embed/" + Q(this.i, "videoId"));
        hb.test(c) && (-1 != c.indexOf("&") && (c = c.replace(bb, "&amp;")),
        -1 != c.indexOf("<") && (c = c.replace(cb, "&lt;")),
        -1 != c.indexOf(">") && (c = c.replace(db, "&gt;")),
        -1 != c.indexOf('"') && (c = c.replace(eb, "&quot;")),
        -1 != c.indexOf("'") && (c = c.replace(fb, "&#39;")),
        -1 != c.indexOf("\x00") && (c = c.replace(gb, "&#0;")));
        return '<iframe width="' + a + '" height="' + b + '" src="' + c + '" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>'
    }
    ;
    r.getOptions = function(a) {
        return this.D.namespaces ? a ? this.D[a].options || [] : this.D.namespaces || [] : []
    }
    ;
    r.getOption = function(a, b) {
        if (this.D.namespaces && a && b)
            return this.D[a][b]
    }
    ;
    function Nh(a) {
    ...
    Y.prototype.getIframe = Y.prototype.va;
    ...
    Xe.push(function(a) {
        var b = a;
        b || (b = document);
        a = Qa(b.getElementsByTagName("yt:player"));
        var c = b || document;
    ...
    "undefined" != typeof YTConfig && YTConfig.parsetags && "onload" != YTConfig.parsetags || Ze();
    var Oh = B.onYTReady;
    Oh && Oh();
    var Ph = B.onYouTubeIframeAPIReady;
    Ph && Ph();
    var Qh = B.onYouTubePlayerAPIReady;
    Qh && Qh();
}
).call(this);
