...
0000000000000358 <.note.gnu.build-id>:
 ...
 367:	00 77 e1             	add    %dh,-0x1f(%rdi)
 36a:	68 b1 af d1 7f       	pushq  $0x7fd1afb1
 36f:	97                   	xchg   %eax,%edi
 370:	0e                   	(bad)  
 371:	79 78                	jns    3eb <_init-0xc15>
 373:	56                   	push   %rsi
 374:	84 a0 9a 4d 3a 69    	test   %ah,0x693a4d9a(%rax)
 37a:	80                   	.byte 0x80
 37b:	dc                   	.byte 0xdc
...
00000000000003c8 <.dynsym>:
	...
 3e0:	3e 00 00             	add    %al,%ds:(%rax)
 3e3:	00 20                	add    %ah,(%rax)
	...
 3f5:	00 00                	add    %al,(%rax)
 3f7:	00 2c 00             	add    %ch,(%rax,%rax,1)
 3fa:	00 00                	add    %al,(%rax)
 3fc:	12 00                	adc    (%rax),%al
	...
 40e:	00 00                	add    %al,(%rax)
 410:	1a 00                	sbb    (%rax),%al
 ...
 43f:	00 69 00             	add    %ch,0x0(%rcx)
 442:	00 00                	add    %al,(%rax)
 444:	20 00                	and    %al,(%rax)
	...
 456:	00 00                	add    %al,(%rax)
 458:	0b 00                	or     (%rax),%eax
...
0000000000000470 <.dynstr>:
 ...
 478:	2e 36 00 5f 5f       	cs add %bl,%ss:0x5f(%rdi)
 47d:	63 78 61             	movslq 0x61(%rax),%edi
 480:	5f                   	pop    %rdi
 481:	66 69 6e 61 6c 69    	imul   $0x696c,0x61(%rsi),%bp
 487:	7a 65                	jp     4ee <_init-0xb12>
 489:	00 5f 5f             	add    %bl,0x5f(%rdi)
 48c:	6c                   	insb   (%dx),%es:(%rdi)
 48d:	69 62 63 5f 73 74 61 	imul   $0x6174735f,0x63(%rdx),%esp
 494:	72 74                	jb     50a <_init-0xaf6>
 496:	5f                   	pop    %rdi
 497:	6d                   	insl   (%dx),%es:(%rdi)
 498:	61                   	(bad)  
 499:	69 6e 00 77 72 69 74 	imul   $0x74697277,0x0(%rsi),%ebp
 4a0:	65 00 47 4c          	add    %al,%gs:0x4c(%rdi)
 4a4:	49                   	rex.WB
 4a5:	42                   	rex.X
 4a6:	43 5f                	rex.XB pop %r15
 4a8:	32 2e                	xor    (%rsi),%ch
 4aa:	32 2e                	xor    (%rsi),%ch
 4ac:	35 00 5f 49 54       	xor    $0x54495f00,%eax
 4b1:	4d 5f                	rex.WRB pop %r15
 4b3:	64 65 72 65          	fs gs jb 51c <_init-0xae4>
 4b7:	67 69 73 74 65 72 54 	imul   $0x4d547265,0x74(%ebx),%esi
 4be:	4d 
 4bf:	43 6c                	rex.XB insb (%dx),%es:(%rdi)
 4c1:	6f                   	outsl  %ds:(%rsi),(%dx)
 4c2:	6e                   	outsb  %ds:(%rsi),(%dx)
 4c3:	65 54                	gs push %rsp
 4c5:	61                   	(bad)  
 4c6:	62                   	(bad)  
 4c7:	6c                   	insb   (%dx),%es:(%rdi)
 4c8:	65 00 5f 5f          	add    %bl,%gs:0x5f(%rdi)
 4cc:	67 6d                	insl   (%dx),%es:(%edi)
 4ce:	6f                   	outsl  %ds:(%rsi),(%dx)
 4cf:	6e                   	outsb  %ds:(%rsi),(%dx)
 4d0:	5f                   	pop    %rdi
 4d1:	73 74                	jae    547 <_init-0xab9>
 4d3:	61                   	(bad)  
 4d4:	72 74                	jb     54a <_init-0xab6>
 4d6:	5f                   	pop    %rdi
 4d7:	5f                   	pop    %rdi
 4d8:	00 5f 49             	add    %bl,0x49(%rdi)
 4db:	54                   	push   %rsp
 4dc:	4d 5f                	rex.WRB pop %r15
 4de:	72 65                	jb     545 <_init-0xabb>
...
0000000000001050 <write@plt>:
    ...
    1054:	f2 ff 25 75 2f 00 00 	bnd jmpq *0x2f75(%rip)        # 3fd0 <write@GLIBC_2.2.5>
...
0000000000001149 <main>:
    ...
    1151:	ba 14 00 00 00       	mov    $0x14,%edx
...
0000000000002058 <__FRAME_END__-0x104>:
    ...
    20e8:	61                   	(bad)  
    20e9:	f0 ff                	lock (bad) 
    20eb:	ff 25 00 00 00 00    	jmpq   *0x0(%rip)        # 20f1 <__GNU_EH_FRAME_HDR+0xdd>
...
0000000000003dc8 <_DYNAMIC>:
    ...
    3e6f:	00 83 00 00 00 00    	add    %al,0x0(%rbx)
